...
UserDat.Dimension      = input('Give the problem dimension: ');
% Input the Primary/Secondary
% See the description above before entering Primary and Secondary
UserDat.Primary        = input('Enter the primary body (string input):');
UserDat.Secondary      = input('Enter the secondary body (string input):');

% Input for how many equilibrium points you want the data for ?(Max 3-
% L1,L2,L3)
UserDat.PointLoc       = input('For how many  equilibrium points do you want orbit parameters? :');
% Enter the number of families
UserDat.NoofFam        = input('Enter No of Lyapunov orbit families:');
% Check if you want to see correction plot(Enter 0 or 1).
UserDat.CorrectionPlot = input('Do You want to see correction plot of differential correction?:');
...
fprintf('\n')
save LyapOrbPar LyapOrb % all the parameters of the Lyapunov orbits are saved in a structure file
                  %% ---------------------Plots Section-----------------------------
