...
switch type
    case '2DContour'
        ...
        %saveas(gcf, 'G:\My Drive\MATLAB\Matlb3BP\ThreeBodyProblemCodes\3BPRefresh\Figures\ContourPlot', 'pdf');
    ...
    case '3DSurface'
        ...
        set(gcf,'PaperPosition',[0 0 5 5]);
        set(gcf,'PaperSize',[5 5])
        %saveas(gcf, 'G:\My Drive\MATLAB\Matlb3BP\ThreeBodyProblemCodes\3BPRefresh\Figures\SurafcePlot', 'pdf');
    ...
    case 'EquilPointsNPrim'
        ...
        xlabel('\it{x-axis}')
        ylabel('\it{y-axis}')
        title('Equilibrium Points and Primaries')
        
        set(gcf,'PaperPosition',[0 0 5 5]);
        set(gcf,'PaperSize',[5 5])
        %saveas(gcf, 'G:\My Drive\MATLAB\Matlb3BP\ThreeBodyProblemCodes\3BPRefresh\Figures\PrimAndEqPts', 'pdf');
