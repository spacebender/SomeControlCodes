...
function LyapunovPlotter(G_var)
...
for i = 1: 2: NoofFam
    ...
    %saveas(gcf, 'G:\My Drive\MATLAB\Matlb3BP\ThreeBodyProblemCodes\3BPRefresh\Figures\Lyap_L1_Lyap_L2_Lyap_LyapEigenss', 'pdf');
...
for i = 1: 2: NoofFam
 ...
 grid on
    ...
    set(gcf,'PaperPosition',[0 0 5 5]);
    set(gcf,'PaperSize',[5 5])
    %saveas(gcf, 'G:\My Drive\MATLAB\Matlb3BP\ThreeBodyProblemCodes\3BPRefresh\Figures\Lyap_L1_Lyap_LyapEigenss', 'pdf');
...
for i = 1: 2: NoofFam
 ...
 grid on
    ...
    set(gcf,'PaperPosition',[0 0 5 5]);
    set(gcf,'PaperSize',[5 5])
    %saveas(gcf, 'G:\My Drive\MATLAB\Matlb3BP\ThreeBodyProblemCodes\3BPRefresh\Figures\Lyap_L2_Lyap_LyapEigenss', 'pdf');
